...
// Cardboard
struct  Cardboard_t7_18  : public MonoBehaviour_t5_104
{
...
struct Cardboard_t7_18_StaticFields{
	// Cardboard Cardboard::sdk
	Cardboard_t7_18 * ___sdk_2;
	// UnityEngine.Camera Cardboard::currentMainCamera
	Camera_t5_98 * ___currentMainCamera_3;
	// StereoController Cardboard::currentController
	StereoController_t7_19 * ___currentController_4;
	// BaseVRDevice Cardboard::device
	BaseVRDevice_t7_20 * ___device_15;
	// UnityEngine.RenderTexture Cardboard::stereoScreen
	RenderTexture_t5_52 * ___stereoScreen_17;
};
